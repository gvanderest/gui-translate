...
class Late {
    static setLocale(id) {}
    static addLocale(id, options) {}
    static addStrings(id, strings) {}
    static translate(key, values) {}
    static setUnsafeHtmlState(state) {}
    static getUnsafeHtmlState() {
        return true;
    }
}
/* harmony export (immutable) */ __webpack_exports__["default"] = Late;


const t = Late.translate;
/* harmony export (immutable) */ __webpack_exports__["t"] = t;


class Translate extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    render() {
        ...
        if (allowHtml) {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { dangerouslySetInnerHTML: { __html: result } });
        }
